<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fandashboard2.aspx.cs" Inherits="zfit.fandashboard" %>
		...
		<div id="st-container" class="st-container">
			...
			<div class="st-pusher">
				<nav class="st-menu st-effect-6" id="menu-6">
					<h2 class="icon icon-stack">Navigation</h2>
					<ul>
				...
				<div class="st-content"><!-- this is the wrapper for the content -->
					<div class="st-content-inner"><!-- extra div for emulating position:fixed of the menu -->
						...
						<header class="codrops-header">
							<h1>Welcome to Kinometric<span>The shape you're in?</span></h1>
						</header>
